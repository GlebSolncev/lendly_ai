        ...
        if (proceed) {
            ...
            $.post(url, post_data, function (response) {
                ...
                if (response.type == 'error') {
                    output = '<div class="alert-danger" style="padding:10px; margin-bottom:30px;">' + 'Sending data error' + '</div>';
                } else {
                    output = '<div class="alert-success" style="padding:10px; margin-bottom:30px;">' + 'Form successfully submitted' + '</div>';
